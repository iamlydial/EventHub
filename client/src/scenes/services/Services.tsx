...
import backgroundImage from "../../GalleryComponent/backgroundImage.jpg"
...
const Services: React.FC = () => {
  return (
    ...
    <div className="gridContainer">
      <div className="sHeading bg-cover bg-center h-3/4 bg-onyx rounded-lg m-10 mt-20">
      ...
      <div className="userJourney p-10 m-20 flex flex-col items-center bg-white rounded-lg opacity-0.5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-4 p-5 flex flex-col items-center">
          ...
          <div className="serviceTab bg-onyx text-white text-center p-8 rounded-lg w-2/3">SignUp/ Login</div>
          ...
          <div className="flex items-center w-3/3 flex flex-col items-center p-5">
          <div className="serviceTab bg-onyx text-white text-center p-8 rounded-lg w-2/3">Create Account</div>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="25" height="25"><path d="M13.03 8.22a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L3.47 9.28a.751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018l2.97 2.97V3.75a.75.75 0 0 1 1.5 0v7.44l2.97-2.97a.75.75 0 0 1 1.06 0Z"></path></svg></div>
          
          <div className="flex items-center w-3/3 flex flex-col items-center p-5">
          <div className="serviceTab bg-onyx text-white text-center p-8 rounded-lg w-2/3" >Select Occasion</div>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="25" height="25"><path d="M13.03 8.22a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L3.47 9.28a.751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018l2.97 2.97V3.75a.75.75 0 0 1 1.5 0v7.44l2.97-2.97a.75.75 0 0 1 1.06 0Z"></path></svg></div>
          
          <div className="flex items-center w-3/3 flex flex-col items-center p-5">
          <div className="serviceTab bg-onyx text-white text-center p-8 rounded-lg w-2/3" >Start Creating your Event</div>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="25" height="25"><path d="M13.03 8.22a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L3.47 9.28a.751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018l2.97 2.97V3.75a.75.75 0 0 1 1.5 0v7.44l2.97-2.97a.75.75 0 0 1 1.06 0Z"></path></svg></div>
          
          <div className="flex items-center w-3/3 flex flex-col items-center p-5">
          <div className="serviceTab bg-onyx text-white text-center p-8 rounded-lg w-2/3" >Select Package Theme </div>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="25" height="25"><path d="M13.03 8.22a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L3.47 9.28a.751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018l2.97 2.97V3.75a.75.75 0 0 1 1.5 0v7.44l2.97-2.97a.75.75 0 0 1 1.06 0Z"></path></svg></div>
          
          <div className="flex items-center w-3/3 flex flex-col items-center p-5">
          <div className="serviceTab bg-onyx text-white text-center p-8 rounded-lg w-2/3" >Select Catering</div>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="25" height="25"><path d="M13.03 8.22a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L3.47 9.28a.751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018l2.97 2.97V3.75a.75.75 0 0 1 1.5 0v7.44l2.97-2.97a.75.75 0 0 1 1.06 0Z"></path></svg></div>
          
          <div className="flex items-center w-3/3 flex flex-col items-center p-5">
          <div className="serviceTab bg-onyx text-white text-center p-8 rounded-lg w-2/3" >Select Location</div>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="25" height="25"><path d="M13.03 8.22a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L3.47 9.28a.751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018l2.97 2.97V3.75a.75.75 0 0 1 1.5 0v7.44l2.97-2.97a.75.75 0 0 1 1.06 0Z"></path></svg></div>
          
          <div className="flex items-center w-3/3 flex flex-col items-center p-5">
          <div className="serviceTab bg-onyx text-white text-center p-8 rounded-lg w-2/3" >Select Styling Preference</div>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="25" height="25"><path d="M13.03 8.22a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L3.47 9.28a.751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018l2.97 2.97V3.75a.75.75 0 0 1 1.5 0v7.44l2.97-2.97a.75.75 0 0 1 1.06 0Z"></path></svg></div>
          
          <div className="flex items-center w-3/3 flex flex-col items-center p-5">
          <div className="serviceTab bg-onyx text-white text-center p-8 rounded-lg w-2/3" >Submit Your Event Request!</div>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="25" height="25"><path d="M13.03 8.22a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L3.47 9.28a.751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018l2.97 2.97V3.75a.75.75 0 0 1 1.5 0v7.44l2.97-2.97a.75.75 0 0 1 1.06 0Z"></path></svg></div>
          
          <div className="flex items-center w-3/3 flex flex-col items-center p-5">
          <div className="serviceTab bg-onyx text-white text-center p-8 rounded-lg w-2/3" >Confirm Date and Time</div>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="25" height="25"><path d="M13.03 8.22a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L3.47 9.28a.751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018l2.97 2.97V3.75a.75.75 0 0 1 1.5 0v7.44l2.97-2.97a.75.75 0 0 1 1.06 0Z"></path></svg></div>

          <div className="flex items-center w-3/3 flex flex-col items-center p-5">
          <div className="serviceTab bg-onyx text-white text-center p-8 rounded-lg w-2/3" >Your Finished!</div>
        </div>
